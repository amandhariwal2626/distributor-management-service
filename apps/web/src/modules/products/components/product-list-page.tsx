...
export function ProductListPage() {
  ...
  const brandOptions = (brandsQ.data ?? []).map((b) => ({
    value: b.id,
    label: b.name,
  }));
  ...
  if (filters.brandId)
    chips.push({
      ...
      label: "Brand",
      value:
        brandOptions.find((b) => b.value === filters.brandId)?.label ??
        filters.brandId,
    });
  if (filters.categoryId)
    chips.push({
      ...
      label: "Category",
      value:
        categoryOptions.find((c) => c.value === filters.categoryId)?.label ??
        filters.categoryId,
    });
  if (filters.status)
      ...
      <div className="rounded-lg border border-border bg-card p-3">
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <SearchableCombobox
            ...
            onChange={(v) =>
              setFilters((f) => ({ ...f, brandId: v || undefined }))
            }
          ...
          <Select
            ...
            onValueChange={(v) =>
              setFilters((f) => ({
                ...f,
                status: (v || undefined) as ProductStatus | undefined,
              }))
            }
          >
            <SelectTrigger>
