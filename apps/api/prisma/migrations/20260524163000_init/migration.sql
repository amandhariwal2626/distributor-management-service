...
-- CreateIndex
CREATE INDEX "InviteToken_tenantId_invitedEmail_idx" ON "InviteToken"("tenantId", "invitedEmail");
...
-- AddForeignKey
ALTER TABLE "InviteToken" ADD CONSTRAINT "InviteToken_inviteSentBy_fkey" FOREIGN KEY ("inviteSentBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
